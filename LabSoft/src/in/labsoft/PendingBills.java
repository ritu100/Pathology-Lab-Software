...
public class PendingBills extends JInternalFrame {
	...
	public PendingBills(FormMainGUI rm,JDesktopPane jp) {
		super("Customer : Test Bill Details",false,true,false,true);
		this.mainForm = rm;
		this.jdp=jp;
		getContentPane().setLayout(null);
		
		panel = new JPanel();
		panel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 255)), "List of Pending Bills", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(128, 0, 0)));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {					
					...
					jp.add(new TestBills(jp,rID,rDate,pName,dName,tName));
